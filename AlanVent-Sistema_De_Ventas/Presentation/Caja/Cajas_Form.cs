...
namespace AlanVent_Sistema_De_Ventas.Presentation.Caja
{
    public partial class Cajas_Form : Form
    {
        ...
        {
            PanelGrafica.Location = new Point((Width - PanelGrafica.Width) / 2, 25);
        ...
        private void Dibujar_Caja_Principal()
        {
            try
            {
                ...
                cn.Open();
                SqlCommand cmd = new SqlCommand("Mostrar_caja_principal", cn);
                ...
                while (rdr.Read())
                {
                    ...
                    LABELusuario.Text = "Por " + rdr["NombreYApellido"].ToString();
        ...
        private void dibujarCAJAS_REMOTAS()
        {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    ...
                    L.Name = rdr["Id_Caja"].ToString();
                    L.Size = new System.Drawing.Size(175, 25);
                    L.Font = new System.Drawing.Font("Courier New", 15);
                    L.AutoSize = false;
                    L.BackColor = Color.Transparent;
                    L.ForeColor = Color.White;
                    L.Dock = DockStyle.Fill;
        ...
        int idcaja;
        private void miEventoToolStripEDITAR(Object sender, EventArgs e)
        {
            idcaja = Convert.ToInt32(((ToolStripMenuItem)sender).Tag);
