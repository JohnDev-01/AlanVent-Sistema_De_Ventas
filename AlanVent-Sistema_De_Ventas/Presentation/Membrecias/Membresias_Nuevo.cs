...
namespace AlanVent_Sistema_De_Ventas.Presentation.Membrecias
{
    public partial class Membresias_Nuevo : Form
    {
        public Membresias_Nuevo()
        {
            InitializeComponent();
        }
        string serialPc;
        ...
        string Resultado;
        private void Membresias_Nuevo_Load(object sender, EventArgs e)
        {
            obtener_serialPc();
        }
        ...
        {
            dlg.Filter = "Licencias AlaVent|*.xml";
            dlg.Title = "Cargador de Licencias AlaVent";
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                if (NombreSoftwareLicencia == "AlanVent")
                {
        ...
        private void activarLicenciaManual()
        {
            ...
            string fechaActivacion = Bases.Encriptar(DateTime.Now.ToString("dd/MM/yyyy"));
