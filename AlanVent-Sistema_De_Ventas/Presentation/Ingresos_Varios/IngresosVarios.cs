...
namespace AlanVent_Sistema_De_Ventas.Presentation.Ingresos_Varios
{
    public partial class IngresosVarios : Form
    {
        ...
        private void GuardarRegistro_Click(object sender, EventArgs e)
        {
            ...
            bool estado = DataAccess.Insertar_datos.insertar_Ingresos_varios(txtfecha.Value, txtnrocomprobante.Text,
        ...
        {
            Logic.Bases.Separador_de_Numeros(txtimporte, e);
        }
    }
}
