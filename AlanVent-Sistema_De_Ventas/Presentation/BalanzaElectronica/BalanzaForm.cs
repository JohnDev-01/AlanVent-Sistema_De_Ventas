...
namespace AlanVent_Sistema_De_Ventas.Presentation.BalanzaElectronica
{
    public partial class BalanzaForm : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("El resultadoDiferencia tiene que ser diferente de vacio para confirmar la balanza");
            }
        }
        private void editarBascula()
        {
            ...
            {
                MessageBox.Show("Balanza configurada y guardada correctamente", "Correcto:", MessageBoxButtons.OK, MessageBoxIcon.Information); 
            }
        }
    }
}
